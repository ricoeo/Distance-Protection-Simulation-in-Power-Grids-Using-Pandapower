...
Protection_devices = setup_protection_zones(net_meshed_simple, excel_file)

# Call the function to simulate faults and get protection data
protection_data = simulate_faults_for_all_lines(net_meshed_simple, Protection_devices)

# Convert the list of dictionaries into a DataFrame
protection_df = pd.DataFrame(protection_data)

# write to Excel file
protection_df.to_excel('fault_detection_check_simple_origin_4.xlsx', index=False)

...
# simulate faults
protection_data= simulate_faults_for_all_lines(net_without_AB1, Protection_devices_fix)
...
# write to Excel file
protection_df.to_excel('fault_detection_with_extern_protection_border_AB1.xlsx', index=False)

...
net_without_AB1_sgen =create_network_without_AB1_sgen(excel_file)

# change the protection zone setting according to the external parameters
Protection_devices = setup_protection_zones(net_without_AB1_sgen, excel_file)
external_parameter_file = 'protection_zones_external_parameters_1411.xlsx'
Protection_devices_fix = adjust_protection_zone_ep(external_parameter_file,Protection_devices)

# simulate faults
protection_data= simulate_faults_for_all_lines(net_without_AB1_sgen, Protection_devices_fix)
...
# write to Excel file
protection_df.to_excel('fault_detection_with_extern_protection_border_1411_without_sgn.xlsx', index=False)

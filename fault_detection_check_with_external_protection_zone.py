...
external_parameter_file = 'protection_zones_external_parameters.xlsx'
...
# write to Excel file
protection_df.to_excel('fault_detection_with_new_protection_border_1111.xlsx', index=False)
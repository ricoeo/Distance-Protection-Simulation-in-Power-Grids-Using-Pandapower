...
def filter_device_zone_pylogn(zone_index, device_index, r_arc, protection_device_list):
...
Protect_14_zone1_polygon = filter_device_zone_pylogn(0, device_id, r_arc_2_5, Protection_devices)
Protect_14_zone2_polygon = filter_device_zone_pylogn(1, device_id, r_arc_2_5, Protection_devices)
